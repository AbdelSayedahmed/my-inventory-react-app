      ...
      <fieldset id="input-form__fieldset">
        ...
        <form id="input-form__form" onSubmit={handleSubmit}>
          <div className="input-form__item">
            ...
            <input id="input-form__item__name" type="text" name="itemName" value={formData.itemName} onChange={handleInputChange} required/>
          </div>
          <div className="input-form__item">
            <label htmlFor="input-form__item__description"><span>Item Description</span></label>
            <textarea id="input-form__item__description" name="itemDescription" value={formData.itemDescription} onChange={handleInputChange} required></textarea>
          </div>
          <div className="input-form__item">
            <label htmlFor="input-form__item__image"><span>Image Url</span></label>
            <input id="input-form__item__image" type="text" name="imageUrl" value={formData.imageUrl} onChange={handleInputChange} required/>
          </div>
          <div className="input-form__item">
            <label htmlFor="input-form__item__price"><span>Price</span></label>
            <input id="input-form__item__price" type="text" name="price" value={formData.price} onChange={handleInputChange} required/>
          </div>
          <div className="input-form__item">
            <label htmlFor="input-form__item__condition"><span>Condition</span></label>
            <select id="input-form__item__condition" name="condition" value={formData.condition} onChange={handleInputChange}>
