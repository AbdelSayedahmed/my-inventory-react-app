function EditForm() {
  return (
    <div id="edit-form">
      <a href="javascript:void(0)" className="edit-form__close-btn">&times;</a>
      <fieldset id="edit-form__fieldset">
        ...
        <form id="edit-form__form">
          <div className="edit-form__item">
            <label for="edit-form__item__name">Item Name</label>
            <input id="edit-form__item__name" type="text" required />
          </div>
          <div className="edit-form__item">
            <label for="edit-form__item__description">Item Description</label>
            <textarea id="edit-form__item__description" required></textarea>
          </div>
          <div className="edit-form__item">
            <label for="edit-form__item__image">Image Url</label>
            <input id="edit-form__item__image" type="text" required />
          </div>
          <div className="edit-form__item">
            <label for="edit-form__item__price">Price</label>
            <input id="edit-form__item__price" type="text" required />
          </div>
          <div className="edit-form__item">
            <label for="edit-form__item__condition">Condition</label>
